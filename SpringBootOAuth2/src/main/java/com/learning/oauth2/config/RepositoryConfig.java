 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = "com.learning.oauth2.model", entityManagerFactoryRef = "entityManagerFactory", transactionManagerRef = "transactionManager")
public class RepositoryConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws ClassNotFoundException, PropertyVetoException {
        ...
        emf.setPackagesToScan("com.learning");
        return emf;
    }
}
